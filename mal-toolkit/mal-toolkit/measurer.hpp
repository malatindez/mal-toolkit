...
/**
 * @file measurer.hpp
 * @brief Implements performance measurement and profiling utilities.
 */
...
namespace mal_toolkit
{
    ...
    public:
        /**
         * @struct Measurer::Entry
         * @brief Represents a measurement entry with timestamp and elapsed time information.
         */
        struct Entry
        {
            float entry_time;
