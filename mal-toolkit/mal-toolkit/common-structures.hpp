...
/**
 * @file common-structures.hpp
 * @brief Defines common data structures and types that can be used anywhere.
 */
namespace mal_toolkit
{
    ...
    /**
     * @brief A class that contains a name and can be named and unnamed, but you cant set the name
     * from outside
     * @note This class is constexpr compatible
     */
