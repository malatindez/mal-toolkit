...
#define MAL_TOOLKIT_DECLARE_ENUM_BIT_OPERATORS_EX(ENUM_TYPE, ENUM_TYPE_UNDERLYING)                \
    ...
    {                                                                                              \
        return static_cast<ENUM_TYPE>(static_cast<ENUM_TYPE_UNDERLYING>(a) |                       \
                                      static_cast<ENUM_TYPE_UNDERLYING>(b));                       \
    }                                                                                              \
    inline ENUM_TYPE operator&(ENUM_TYPE a, ENUM_TYPE b)                                           \
    {                                                                                              \
        return static_cast<ENUM_TYPE>(static_cast<ENUM_TYPE_UNDERLYING>(a) &                       \
    ...
    template <std::integral T> inline ENUM_TYPE operator|(ENUM_TYPE a, T b)                        \
    {                                                                                              \
    ...
    template <std::integral T> inline ENUM_TYPE operator|(T a, ENUM_TYPE b)                        \
    {                                                                                              \
...
#define MAL_TOOLKIT_DECLARE_ENUM_BIT_FUNCTIONS(ENUM_TYPE)                                         \
    template <typename T> inline bool HasFlag(ENUM_TYPE a, T b) { return (a & b) == b; }           \
    template <typename T> inline bool HasAnyFlag(ENUM_TYPE a, T b) { return (a & b) != 0; }        \
    template <typename T> inline bool HasAllFlags(ENUM_TYPE a, T b) { return (a & b) == a; }       \
    template <typename T> inline ENUM_TYPE SetFlag(ENUM_TYPE a, T b) { return a | b; }             \
    template <typename T> inline ENUM_TYPE ClearFlag(ENUM_TYPE a, T b) { return a & ~b; }          \
    template <typename T> inline ENUM_TYPE FlipFlag(ENUM_TYPE a, T b) { return a ^ b; }
